...
you may now navigate to [https://localhost:8080](https://localhost:8080) to verify the UI is up and running, it should show the auction created above (it may take a few seconds to appear).
...
```yaml
exerciser: auctionAccount = 0.0.xxxx
  numAccounts = 10
  numThreads = 4
  numTransfers = 4
```
